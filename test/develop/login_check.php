...
// $httpClient = new \LINE\LINEBot\HTTPClient\CurlHTTPClient('YDYCsmgEH7CeBJ8PgtOAddbi01YgqLvpjSG+dVloDYw94BzLj26yUkgJ0OL132jmZbL/gXy/hmCooiSVyZcI9IoxhmN84y5EUj6CmVvTOoMmYDGBAM6yv3HmX96HW6xKpwTbPoF7YhMH/3awaoH/9gdB04t89/1O/w1cDnyilFU=');
...
$sql = "SELECT * from line_user_register where userId='{$id}' 
AND line_user_register.email = '{$email}' AND line_user_register.pass = '{$pass}' 
