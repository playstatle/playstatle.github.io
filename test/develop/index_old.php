            ...
            if ($query_result['user_type'] === 'UTAC' || ($query_result['user_type'] === 'IFX' && ($value['CUST_CODE'] === 'IFX' || $value['CUST_CODE'] === 'IN6')) || $query_result['user_type'] === $value['CUST_CODE']) {
                ...
                switch($value['CUST_CODE']){
                    ...
                    case 'ONS':
                        ...
                        $result_get .= $EBR_NO.$UTL_LOT.$CUST_ASSY_LOT.$CURRENT_QTY.$SWR_STATUS.$ON_WIP_OPTN_CODE.$ASSY_OUT_DATE.$INVOICE_NO;
                        break;
                    case 'MCH':
                        $CUST_REQ_NO = "";
                        $UTL_LOT = "";
                    ...
                    case 'PII':
                        ...
                        $result_get .= $CUST_REQ_NO.$UTL_LOT.$CUST_ASSY_LOT.$ELR_NO.$SWR_STATUS.$ON_WIP_OPTN_CODE.$CURRENT_QTY.$ASSY_OUT_DATE.$INVOICE_NO;
                        break;
                    case 'IFX':
                    case 'IN6':
                        $CUST_REQ_NO = "";
