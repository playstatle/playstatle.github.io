...
$accessToken = "EgYQRo41FLcFvFX1MBOyeZunsnkiPhXL/uAs4m5sqntXihVW1t75aXTinEULhyf3ZbL/gXy/hmCooiSVyZcI9IoxhmN84y5EUj6CmVvTOoOf/wuPbPJCtLjUixb5pL6K1Udk6Lvo+suSIJlWik23mFGUYhWQfeY8sLGRXgo3xvw=";
...
$message = str_replace('#','%23',strtoupper($arrayJson['events'][0]['message']['text']));
...
if ($num_row >= 1) {
    ...
    if ($count_result > 0) {
        ...
        foreach ($not_duplicate_result as $key => $value) {
            ...
            if ($query_result['user_type'] === 'UTAC' || $query_result['user_type'] === 'UTACG' || ($query_result['user_type'] === 'IFX' && ($customer_type === 'IFX' || $customer_type === 'IN6')) || $query_result['user_type'] === $customer_type) {
                ...
                switch($customer_type){
                    ...
                    case 'EMS':
                        ...
                        if ($value['WIP_LOT_STATUS'] != '') {
                            $result_get .= "📋 ON WIP : " . $value['WIP_LOT_STATUS']."\n";
                        }
                    ...
                    case 'NP3':
						...
						if ($value['CUST_REQ_NO'] != '') {
                            $result_get .= "📑 STR# " . $value['CUST_REQ_NO']."\n";
                        }
				...
				if ($value['CUST_REQ_NO'] != '') {
                            $result_get .= "📑 SWR no. " . $value['CUST_REQ_NO']."\n";
                        }
						...
						if ($value['START_DATE'] != '') {
                            $result_get .= "📋 Assy start : " . $value['START_DATE']."\n";
						}
                ...
                if(substr($message, 0, 2) == '4C' || substr($message, 0, 2) == '4c') {
                    ...
                    switch($query_result['user_type']){
                        ...
                        case 'LTC':
                            ...
                            break;
                        case 'NP3':
                            $contact = 'Benyapa benyapapr@utacgroup.com ; Apinya apinyako@utacgroup.com';
                            break;
                        case 'IFX':
                        case 'IN6':
                        ...
                        case 'ISL':
                            ...
                            break;
                        case 'UTAC':
                            $contact = 'Apinya apinyako@utacgroup.com';
                            break;
                        case 'MT0':
                        case 'EM5':
                        case 'MNS':
                        case 'GTO':
                            $contact = 'Chanthip ekalakkl@utacgroup.com ; Sarayut sarayutch@utacgroup.com ; Jiraporn jarapornpu@utacgroup.com';
                            break;
						case 'AO0':
                            $contact = 'Athisa athisasa@utacgroup.com ; Monsicha monsichath@utacgroup.com ; Alongkorn alongkornma@utacgroup.com';
                            break;
						case 'QI0':
                            $contact = 'Apinya apinyako@utacgroup.com ; Benyapa benyapapr@utacgroup.com';
                            break;
                        default:
